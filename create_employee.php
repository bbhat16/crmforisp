<?php
	if (isset($_POST['submit']))
	{
      ...
      echo "<script type = 'text/javascript'>alert('$message2');</script>";
		...
		{
            $x="insert into users (username,password,user_type) values ('$username','$password','employee')";
            $t = "insert into rate (name,username) values ('$name','$username')";
            mysqli_query($link , $x);
            mysqli_query($link , $t);
...
<div class ="wrapper">           
    ...
    <h2 class='signup'> <font color="black"> Enter Employee Details</h2>
