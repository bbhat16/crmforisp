...
if (isset($_POST['submit']))
{
  ...
  $s = "select  *from users where username = '$username' and user_type='employee' ";
  $result = mysqli_query($conn , $s);
  $n = mysqli_affected_rows($conn);
  if ($n == 0)
  {
    $message2 ="username not found";
 ...
 { $query1 = "DELETE FROM users WHERE username = '$username'";       
  ...
  $message1 ="Record deleted successfullyy";
...
<style type="text/css">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <h2 class='signup'> <font color="black"> Enter Employee Credintials</h2>
