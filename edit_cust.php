...
while($row = mysqli_fetch_array($result)) {
  ...
  echo "<td><form method = 'GET' action = 'reset-password-cust.php'><input type='hidden' name='cid' value='$cid'><button class='btn btn-outline-dark' type='submit'>Change password</button></form></td>";
echo "</tr>";
}
echo "</tbody></table>";
